    ...
    <div class="content">
      ...
      <div class="main-form">
        <div class="bill-block" v-for="(reception, index) in receptionList">
          <label
            class="carrierId"
            v-text="reception.carrier.carriersId"
          ></label>
          <div class="driver">
            <el-avatar
              type="image"
              class="image"
              src="https://img02.sogoucdn.com/app/a/100520093/8379901cc65ba509-45c21ceb904429fc-e8e0ced72c7814e527ca276e0fe48673.jpg"
            ></el-avatar>
            <div class="driver-info">
              <el-tag
                class="main-font driver-tag"
                v-text="
                  '驾驶员#' +
                  reception.driver.driverId +
                  ' ' +
          ...
          <div class="carrier-info">
            <div class="send-info">
              <label
                v-text="reception.carrier.sendCompany"
                class="title-font"
              ></label>
              <label
                v-text="reception.carrier.sendAddress"
                class="third-font"
              ></label>
              <label
                v-text="reception.carrier.sendLinkman"
                class="second-font"
              ></label>
              <label
                v-text="reception.carrier.sendPhone"
                class="fourth-font"
              ></label>
            </div>
            <div class="time">
              ...
              <label
                v-text="'起: ' + reception.carrier.leaverDate"
                class="third-font"
              ></label>
              <label
                v-text="'终: ' + reception.carrier.receiveDate"
                class="third-font"
              ></label>
            </div>
            <div class="receive-info">
              <label
                v-text="reception.carrier.receiveCompany"
                class="title-font"
              ></label>
              <label
                v-text="reception.carrier.receiveAddress"
                class="third-font"
              ></label>
              <label
                v-text="reception.carrier.receiveLinkman"
                class="second-font"
              ></label>
              <label
                v-text="reception.carrier.receivePhone"
                class="fourth-font"
              ></label>
            </div>
          </div>
          <div class="manager-info">
            <label
              ...
              v-text="'处理管理员: #' + reception.carrier.account"
            ></label>
            <div class="actions">
              <el-button
                type="primary"
                class="infoBtn"
                @click="receptCarrierBtnClick(index)"
                >接收</el-button
              >
        ...
        <div class="form">
          <el-descriptions title="承运单信息" size="large" column="3" border>
            <el-descriptions-item label="承运单编号">{{
              receptCarrier.carriersId
            }}</el-descriptions-item>
            <el-descriptions-item label="登记时间">{{
              receptCarrier.checkInTime
            }}</el-descriptions-item>
            <el-descriptions-item label="发货公司">{{
              receptCarrier.sendCompany
            }}</el-descriptions-item>
            <el-descriptions-item label="发货地址">{{
              receptCarrier.sendAddress
            }}</el-descriptions-item>
            <el-descriptions-item label="收货公司">{{
              receptCarrier.receiveCompany
            }}</el-descriptions-item>
            <el-descriptions-item label="收货地址">{{
              receptCarrier.receiveAddress
            }}</el-descriptions-item>
          </el-descriptions>
        </div>
        <div class="actions">
