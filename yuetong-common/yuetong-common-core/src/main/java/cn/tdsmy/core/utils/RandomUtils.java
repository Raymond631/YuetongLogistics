...
public class RandomUtils {
     ...
     * @return
     */
    public static List<String> getRandomAccounts(List<String> oldUserIds, int num) {
     ...
     * @return
     */
    public static List<String> getRandomPasswords(int num, Integer wordNum) {
